...
CREATE  TABLE provider (
  prv_id numeric GENERATED ALWAYS as IDENTITY(START with 1 INCREMENT by 1) PRIMARY KEY,
...
CREATE TABLE claims (
  claim_No numeric GENERATED ALWAYS as IDENTITY(START with 1 INCREMENT by 1) PRIMARY KEY,
...
DROP TABLE  member;
CREATE TABLE member(
  member_id numeric GENERATED ALWAYS as IDENTITY(START with 1 INCREMENT by 1) PRIMARY KEY,
...
DROP TABLE  provider_network;
CREATE TABLE provider_network(
  prv_network_id numeric GENERATED ALWAYS as IDENTITY(START with 1 INCREMENT by 1) PRIMARY KEY,
  prv_npi VARCHAR(20) NOT NULL,
  prv_tin VARCHAR(20) NOT NULL,
